...
description = "Will delete the given poicy form the dashboard or gateway"
...
parser.add_argument('--policyid', '-p', required=True, dest='policyid', help="Policy ID")
...
resp = tykInstance.deletePolicy(args.policyid)
